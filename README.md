...
YellowTDS — TDS для маршрутизации трафика по правилам кампаний. Проект включает движок фильтрации и распределения трафика, SQLite-хранилище, админ-панель, статистику, click logs, postback-обработку и несколько режимов интеграции.
