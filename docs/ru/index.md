...
2. Для чистого VPS выполните [Установку на VPS](installation.md), а для сервера с панелью — [Установку через панели управления](hosting-panels.md).
