...
final class EventTrackingAssetsTest extends TestCase
{
    ...
    {
        $transport = file_get_contents(__DIR__ . '/../scripts/eventtracking.js');
        $scroll = file_get_contents(__DIR__ . '/../scripts/scrolltracking.js');
        $visibleTime = file_get_contents(__DIR__ . '/../scripts/visibletimetracking.js');
        $custom = file_get_contents(__DIR__ . '/../scripts/customeventtracking.js');
        $performance = file_get_contents(__DIR__ . '/../scripts/performancetracking.js');
    ...
    {
        $bundle = __DIR__ . '/../scripts/vendor/web-vitals-5.3.0/web-vitals.iife.js';
        $license = __DIR__ . '/../scripts/vendor/web-vitals-5.3.0/LICENSE';
    ...
    {
        $formSubmit = file_get_contents(__DIR__ . '/../admin/js/campsettings/form-submit.js');
    ...
    {
        $form = file_get_contents(__DIR__ . '/../admin/campsettings.php');
        $eventsUi = file_get_contents(__DIR__ . '/../admin/js/campsettings/events.js');
